...
def parse_args():
    ...
    parser.add_argument('--output_dir', type=str, default='./datasets/exprs_map/default', help='experiment id')
    parser.add_argument('--seed', type=int, default=0)
    parser.add_argument('--pairing', type=str, default='prior', choices=['prior', 'random'],
                        help="how episodes are paired into concurrent (main, aux) agents within a scan: "
                             "'prior' maximises ground-truth path overlap, 'random' pairs at random")
    ...
    # LLM
    parser.add_argument('--llm', type=str, default='qwen3-vl-32b-instruct')
    parser.add_argument('--response_format', type=str, default='json', choices=['str', 'json'])
    parser.add_argument('--img_root', type=str, default=None, help='root of the pre-rendered observation images')
